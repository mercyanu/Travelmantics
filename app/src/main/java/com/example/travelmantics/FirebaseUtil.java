...
public class FirebaseUtil {
    ...
    public static ListActivity callerActivity;
    public static boolean isAdmin;

    private FirebaseUtil(){};

    public static void openDatabaseRef(String node, ListActivity caller){
        ...
        mDatabaseReference = mFirebaseDatabase.getReference().child(node);
    }
    ...
    private static void checkAdmin(String uid) {
        ...
        ChildEventListener listener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                //this gets called whenever logged in person is in admin node on database
